...
#define UART16550_CLOCK  1843200   //时钟频率
#define UART_DEFAULT_BAUD  115200    //波特率


#define UART        0x10000000

/* THR:transmitter holding register  都是8位 */
#define UART_DAT    (UART+0x00) /* 数据寄存器*/   //也就是RBR THR 收发寄存器
